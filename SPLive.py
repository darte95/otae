    ...
    try:
        while True:
            ...
            if detect_image_on_screen(device_id, keep_templates, keep_sizes):
                ...
                print(get_device_screen_size(device_id))
                if device_id == "5001fc98":
                    simulate_click("5001fc98", 947, 399)
                elif device_id == "734d6104":
                    simulate_click("734d6104", 955, 475)
                time.sleep(2)
